...
import Logo from "../../../assets/logo/hero-v2.svg";

<br/>

<Logo width="300" loading="eager" alt="Logo" />
...
![pattern-overview](../../../assets/diagrams/overview.mmd.svg)
...
The demo was generated with [charmbracelet/vhs][linkCharmbraceletVHS] using the
3 Musketeers ([source][linkProjectDemo]).

:::

![Animated demo](https://raw.githubusercontent.com/flemay/3musketeers/vhs-demo/demo.gif)

---

:::note

The 3 Musketeers is not affiliated with Docker, Inc. or Docker Project in any
way. The logo was inspired by existing drawings on the Internet.

:::

:::caution[Opinionated]

This website contains opinionated guidelines and tips based on our experience
using the 3 Musketeers and are subject to change over time. Feel free to
use/share your own guidelines, or even [contribute][linkContributing].

:::

[linkContributing]: /about/contributing
[linkCharmbraceletVHS]: https://github.com/charmbracelet/vhs
[linkProjectDemo]: https://github.com/flemay/3musketeers/tree/main/demo
